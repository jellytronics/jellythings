...
select choice in "Mifare Project" "Software Defined Radio Project" "System I/O Utilities" "Kill all TMUX Sessions" "Run All Installation Scripts" "Run Installation Scripts Interactively" "Run Startup Scripts" "Update All" "Update All -force" "Make files executable" "Exit"; do
    case $choice in
